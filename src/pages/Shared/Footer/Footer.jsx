    ...
    return (
        <footer className="bg-slate-500 p-10">
            <div className='w-11/12 mx-auto footer text-neutral-content flex justify-between'>
                <div>
                    <Link to="/" className=" text-xl md:text-3xl gap-3 font-semibold">
            ...
            <h4 className='text-white text-center text-md md:text-lg mt-3'>Copyright &copy; All right reserved by Mishk@t - {new Date().getFullYear()} </h4>
        </footer>
    );
};
